...
def test_get_meta():
    json_meta = get_meta("sample_data/subset_data_1/subset_data_1.tif", outputfile="temp_output.json")
    dataset1 = apply_meta("temp_output.json", "sample_data/full_data_1/full_data_1.tif")
